...
function printNavbar() {
	...
	echo '<nav class="linear navbar navbar-inverse navbar-fixed-top" role="navigation">
				<div class="container animated fadeIn">
					<div class="navbar-header">
						...
						global $isBday;
						echo $isBday ? '<a class="navbar-brand" href="/"><i class="fa fa-birthday-cake"></i><img src="images/logos/text.png" style="display: inline; padding-left: 10px; margin-top:-5px;"></a>' : '<a class="navbar-brand" href="/"><img src="/images/logos/text.png"></a>';
					echo '</div>
